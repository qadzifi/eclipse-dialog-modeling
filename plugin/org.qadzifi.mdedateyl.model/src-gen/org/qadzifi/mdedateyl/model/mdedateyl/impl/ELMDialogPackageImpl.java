 ...
 * @generated
 */
public class ELMDialogPackageImpl extends EPackageImpl implements ELMDialogPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.qadzifi.mdedateyl.model.mdedateyl.ELMDialogPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ELMDialogPackageImpl() {
		super(eNS_URI, ELMDialogFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link ELMDialogPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ELMDialogPackage init() {
		if (isInited)
			return (ELMDialogPackage) EPackage.Registry.INSTANCE.getEPackage(ELMDialogPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredELMDialogPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ELMDialogPackageImpl theELMDialogPackage = registeredELMDialogPackage instanceof ELMDialogPackageImpl
				? (ELMDialogPackageImpl) registeredELMDialogPackage
				: new ELMDialogPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theELMDialogPackage.createPackageContents();

		// Initialize created meta-data
		theELMDialogPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theELMDialogPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ELMDialogPackage.eNS_URI, theELMDialogPackage);
		return theELMDialogPackage;
	}
	 ...
	 * @generated
	 */
	public ELMDialogFactory getELMDialogFactory() {
		return (ELMDialogFactory) getEFactoryInstance();
	}

 ...
 * @generated
 */
public class MdedateylPackageImpl extends EPackageImpl implements MdedateylPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.qadzifi.mdedateyl.model.mdedateyl.MdedateylPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MdedateylPackageImpl() {
		super(eNS_URI, MdedateylFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link MdedateylPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MdedateylPackage init() {
		if (isInited)
			return (MdedateylPackage) EPackage.Registry.INSTANCE.getEPackage(MdedateylPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredMdedateylPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		MdedateylPackageImpl theMdedateylPackage = registeredMdedateylPackage instanceof MdedateylPackageImpl
				? (MdedateylPackageImpl) registeredMdedateylPackage
				: new MdedateylPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theMdedateylPackage.createPackageContents();

		// Initialize created meta-data
		theMdedateylPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theMdedateylPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MdedateylPackage.eNS_URI, theMdedateylPackage);
		return theMdedateylPackage;
	}
	 ...
	 * @generated
	 */
	public MdedateylFactory getMdedateylFactory() {
		return (MdedateylFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDialogContainer_Title(), ecorePackage.getEString(), "Title", "Title Text", 1, 1,

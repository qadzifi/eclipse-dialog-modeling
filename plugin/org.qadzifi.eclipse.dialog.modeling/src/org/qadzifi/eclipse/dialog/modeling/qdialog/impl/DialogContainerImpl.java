 ...
 * </p>
 * <ul>
 *   <li>{@link org.qadzifi.eclipse.dialog.modeling.qdialog.impl.DialogContainerImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.qadzifi.eclipse.dialog.modeling.qdialog.impl.DialogContainerImpl#getTextinput <em>Textinput</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DialogContainerImpl extends MinimalEObjectImpl.Container implements DialogContainer {
	...
	protected EClass eStaticClass() {
		return QDialogPackage.Literals.DIALOG_CONTAINER;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QDialogPackage.DIALOG_CONTAINER__TITLE, oldTitle,
					title));
	}
	...
	public EList<TextInput> getTextinput() {
		if (textinput == null) {
			textinput = new EObjectContainmentEList<TextInput>(TextInput.class, this,
					QDialogPackage.DIALOG_CONTAINER__TEXTINPUT);
		}
		return textinput;
	}
